DEVELOPER: Replace the three occurrences of PyCharmPortable in this file
...
user in an INI file next to *PyCharmPortable.exe called PyCharmPortable.ini.
...
copy AppNamePortable.ini from this directory to PyCharmPortable.ini next to
PyCharmPortable.exe. The options in the INI file are as follows:
